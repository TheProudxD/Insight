...
namespace Storage
{
	public class SceneManager
	{
		...
		private SceneManager(IDynamicStorageService dynamicStorageService, DataManager dataManager, WindowManager windowManager)
		{
		...
		public void LoadScene(Scenes scene) => UnityEngine.SceneManagement.SceneManager.LoadScene((int)scene);
	}
}