...
namespace Zenject
{
        ...
        //where T : Component
    {
        ...
        public virtual T Create(string projectilePrefab, P1 param, P2 param2)
        {
            Assert.That(!string.IsNullOrEmpty(projectilePrefab),
              "Null or empty prefab resource name given to factory create method when instantiating object with type '{0}'.", typeof(T));

            var prefab = (GameObject)Resources.Load(projectilePrefab);
